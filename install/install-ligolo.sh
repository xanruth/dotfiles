...
sudo wget \
    https://github.com/nicocha30/ligolo-ng/releases/download/v0.5.2/ligolo-ng_agent_0.5.2_linux_amd64.tar.gz \
    https://github.com/nicocha30/ligolo-ng/releases/download/v0.5.2/ligolo-ng_proxy_0.5.2_linux_amd64.tar.gz \
    https://github.com/nicocha30/ligolo-ng/releases/download/v0.5.2/ligolo-ng_agent_0.5.2_windows_amd64.zip \
    https://github.com/nicocha30/ligolo-ng/releases/download/v0.5.2/ligolo-ng_proxy_0.5.2_windows_amd64.zip
...
sudo tar -xzf ligolo-ng_agent_0.5.2_linux_amd64.tar.gz
sudo tar -xzf ligolo-ng_proxy_0.5.2_linux_amd64.tar.gz
sudo unzip -o ligolo-ng_agent_0.5.2_windows_amd64.zip
sudo unzip -o ligolo-ng_proxy_0.5.2_windows_amd64.zip
